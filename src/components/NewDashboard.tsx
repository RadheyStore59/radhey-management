        ...
        <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 border border-slate-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button 
              ...
              className="flex items-center justify-center gap-3 p-4 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-100 transition-colors"
            >
            ...
            <button 
              ...
              className="flex items-center justify-center gap-3 p-4 bg-green-50 text-green-600 rounded-xl hover:bg-green-100 transition-colors"
            >
            ...
            <button 
              ...
              className="flex items-center justify-center gap-3 p-4 bg-purple-50 text-purple-600 rounded-xl hover:bg-purple-100 transition-colors"
            >
