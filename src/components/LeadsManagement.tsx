  ...
  return (
    <div className="p-8 bg-gray-50/30 min-h-screen font-sans">
      <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tight leading-none mb-3">Leads Management</h1>
          <p className="text-slate-500 font-medium text-lg">Manage and track your business leads</p>
        </div>
        <div className="flex items-center gap-4">
          <div className="bg-white px-6 py-4 rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col items-end relative overflow-hidden group">
            ...
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest relative z-10">Total Leads</span>
            <span className="text-3xl font-black text-slate-900 relative z-10">{filteredLeads.length}</span>
          </div>
          <div className="bg-white px-6 py-4 rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col items-end relative overflow-hidden group">
            ...
            <span className="text-[10px] font-bold text-emerald-500 uppercase tracking-widest relative z-10">Active Leads</span>
            <span className="text-3xl font-black text-emerald-600 relative z-10">{filteredLeads.filter(lead => lead.status === 'New' || lead.status === 'Contacted').length}</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
            ...
            <div className="flex items-center gap-2 ml-auto lg:ml-0">
              <button
                ...
                className="flex items-center gap-2 bg-slate-900 text-white px-8 py-3 rounded-xl hover:bg-slate-800 transition-all shadow-[0_10px_20px_-5px_rgba(0,0,0,0.15)] hover:shadow-[0_15px_25px_-5px_rgba(0,0,0,0.2)] text-sm font-bold active:scale-95"
              >
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-slate-100">
            ...
            <div className="px-8 py-6 border-t border-slate-100 bg-slate-50/50 flex justify-end gap-3">
              ...
              <button
                ...
                form="lead-form"
                disabled={loading}
                className="px-10 py-2.5 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-slate-800 transition-all shadow-lg shadow-slate-200 disabled:opacity-50"
              >
